...
import {loadTodo, deleteTodo} from '../actions/index'


class HomePageWithRedux extends React.Component{
    constructor(props){
        super(props)
        this.state = {
            result : []
    ...
    handleRefresh(){
        ...
        .then(res => {
            ...
            //     result : res['data']
            // })
            this.props.dispatch(loadTodo(res['data']))
        })
        .catch(err => {
            console.log(err)
        })
...
function mapStateToProps(state){
    return {
        result : state.todoData.result
    }
}

export default connect(mapStateToProps)(HomePageWithRedux)